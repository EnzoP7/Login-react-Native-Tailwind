  ...
  return (
    <View className="w-full bg-white dark:bg-gray-50/10  rounded-3xl p-5 my-5">
      ...
      <View className="mt-5">
        ...
        <Text className="text-xl font-extrabold dark:text-white">${price * count}</Text>
        </View>
        <Text numberOfLines={2} className="text-sm text-black/60 dark:text-white/70">{description}</Text>
        <TouchableOpacity className="flex-row justify-center bg-black dark:bg-white w-10/12 p-3 self-center mt-5 rounded-full">
